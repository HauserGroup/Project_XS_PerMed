...
data_file_dir="/WGS_Lucia/WGS_QC/Output"

run_plink="plink2 --bfile OPRM1 \
       --recode A \
       --out variants_per_eid"

dx run swiss-army-knife -iin="${data_file_dir}/OPRM1.bed" \
   -iin="${data_file_dir}/OPRM1.bim" \
   -iin="${data_file_dir}/OPRM1.fam" \
