...
run_regenie_step1="regenie --step 1 \
 --out phenos.QT.step1 \
 --bed ukb_allChrs \
 --phenoFile ${data_file_dir}/phenotypes/morphine_codeine_long_term_users_phenotype.QT.tsv --covarFile ${regenie_file_dir_L}/covariates.tsv \
...
dx run swiss-army-knife -iin="${dir_J}/ukb_allChrs.bed" \
   ...
   --tag="Step1_regenie_QT" --instance-type "mem1_ssd1_v2_x16" --destination="${dir_L}/phenos_morphine_codeine_long_term_users.QT.LOCO" --brief --yes \
