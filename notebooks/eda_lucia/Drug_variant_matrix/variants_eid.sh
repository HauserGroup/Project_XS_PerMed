...
# This script extracts genetic variants from a BGEN file, maps them to participant EIDs using a sample file, and exports the data in an allele-based format.
